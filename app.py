...
from resources.director import blp as DirectorBlueprint
from resources.category import blp as CategoryBlueprint

app = Flask(__name__)
app.config["API_TITLE"] = "Movies REST API"
...
app.config["JWT_SECRET_KEY"] = "GHAZI"
jwt = JWTManager(app)
...
api.register_blueprint(DirectorBlueprint)
